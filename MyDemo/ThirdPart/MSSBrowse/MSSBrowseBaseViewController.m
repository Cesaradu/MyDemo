...
{
    self.view.backgroundColor = [UIColor colorWithHexString:@"000000" alpha:0.7];
    if(_snapshotView)
    {
    ...
    _collectionView.backgroundColor = [UIColor colorWithHexString:@"000000" alpha:0.7];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {        
        ...
        [cell longPress:^(MSSBrowseCollectionViewCell *browseCell) {
            __strong __typeof(weakSelf)strongSelf = weakSelf;
            if([[SDImageCache sharedImageCache] diskImageDataExistsWithKey:browseItem.bigImageUrl])
            {
