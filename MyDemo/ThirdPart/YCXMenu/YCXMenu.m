...
#define kSeparatorInsetLeft     10
#define kSeparatorInsetRight    10
...
- (UIView *)mkContentView {
    ...
    for (YCXMenuItem *menuItem in _menuItems) {
        ...
        if (menuItem.title.length) {
            ...
            titleLabel.textColor = menuItem.foreColor ? menuItem.foreColor : [UIColor colorWithHexString:@"000000" alpha:0.8];
