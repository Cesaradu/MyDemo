...
#define DEFAULT_LABEL_MAX_HEIGHT 20
#define DEFAULT_LABEL_MAX_WIDTH 60

#define DEFAULT_LABEL_MID_HEIGHT 20
#define DEFAULT_LABEL_MID_WIDTH 60

#define DEFAULT_LABEL_MIN_HEIGHT 20
#define DEFAULT_LABEL_MIN_WIDTH 60
...
- (void)updateWithRotateAngle:(CGFloat)angle {
    ...
    for (NSInteger idx = 0; idx < labesCount; ++ idx) {
        ...
        width -= 10;
        width = width > DEFAULT_LABEL_MAX_WIDTH ? DEFAULT_LABEL_MAX_WIDTH : DEFAULT_LABEL_MAX_WIDTH;

        x = labelLeft ? endPoint.x - width : endPoint.x;
        height = labelHeight > DEFAULT_LABEL_MAX_HEIGHT ? DEFAULT_LABEL_MAX_HEIGHT : DEFAULT_LABEL_MAX_HEIGHT;

        y = endPoint.y - height/2;
        labelFrame = CGRectMake(x, y, width, height);
        currentLabel.frame = labelFrame;

        width = width < DEFAULT_LABEL_MIN_WIDTH ? DEFAULT_LABEL_MIN_WIDTH : DEFAULT_LABEL_MIN_WIDTH;
        height = height < DEFAULT_LABEL_MIN_HEIGHT ? DEFAULT_LABEL_MIN_HEIGHT : DEFAULT_LABEL_MAX_HEIGHT;
