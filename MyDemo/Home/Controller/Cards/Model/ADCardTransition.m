...
- (void)pushAnimation:(id<UIViewControllerContextTransitioning>)transitionContext {
    //起始页面
    CardAnimationViewController *fromVC = (CardAnimationViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    //目标页面
...
- (void)popAnimation:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    CardAnimationViewController *toVC = (CardAnimationViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
