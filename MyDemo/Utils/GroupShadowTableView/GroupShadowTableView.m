...
//  Happybird_keanxin
//
//  Created by Oliver on 2017/11/26.
...
- (void)setCornerRadius:(CGFloat)radius withShadow:(BOOL)shadow withOpacity:(CGFloat)opacity {
    ...
    if (shadow) {
        self.layer.shadowColor = [UIColor colorWithHexString:@"9a9a9a" alpha:0.4].CGColor;
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    UIView *headView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, [self Suit:15])];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    UIView *footView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, [self Suit:15])];
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.tableView = [[UITableView alloc] initWithFrame:CGRectInset(self.bounds, [self Suit:10], 0) style:UITableViewStylePlain];
...
- (void)layoutSubviews {
    ...
    [self.tableView setCornerRadius:[self Suit:5] withShadow:YES withOpacity:0.4];
}
